...
This directory holds pre-built `.omod` files (attachments, appointments, communication, fhir2, bahmni-ipd, medication-administration, orderexpansion) that are copied into the OpenMRS Docker image.
